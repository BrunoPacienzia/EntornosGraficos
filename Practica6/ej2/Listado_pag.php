<body> 
    <html> 
        ...
        <body> <?php  include("conexion.inc");  
        $Cant_por_Pag = 2;  
        $pagina = isset ( $_GET['pagina']) ? $_GET['pagina'] : null ; 
        if (!$pagina) { $inicio = 0; $pagina=1; } 
        else { $inicio = ($pagina - 1) * $Cant_por_Pag; }
        ...
        <table border=1> 
            ...
            <?php while ($fila = mysqli_fetch_array($vResultado))  { 
                ...
                <tr>             
                    ...
                    <tr>               
                    <td colspan="5"> <?php } // Liberar conjunto de resultados 
        ...
        <?php if ($total_paginas > 1){ 
            ...
            <p>&nbsp;</p> 
            <p align="center">
                <a href="Menu.html">Volver al menu del AB</a></p> 
            </body> 
        </html> 